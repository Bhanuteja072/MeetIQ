...
MODEL_SIZE   = "base"
COMPUTE_TYPE = "int8"   # int8 = less RAM on CPU, same accuracy
...
def transcribe_audio(file_path: str) -> dict:
    ...
    print(f"✅ Transcription complete. Duration: {total_duration}s, "
          f"Segments: {len(cleaned_segments)}, Language: {info.language}")
